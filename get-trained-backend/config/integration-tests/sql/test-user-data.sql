...
INSERT INTO ORG_COMPANIES VALUES (-1,'2001-01-01 00:00',NULL,0,'','','Kyiv','berize',NULL,'Berize',NULL,'UA', 'EN');
...
INSERT INTO USR_ROLES VALUES
  (-1,'2001-01-01 00:00',NULL,0,'Full rights','BERIZE_ALL', 'SYSTEM', NULL,'EN'),
  (-2,'2001-01-01 00:00',NULL,0,'Role for administrator of system','ROLE_ADMIN', 'SYSTEM', NULL,'EN'),
  (-3,'2001-01-01 00:00',NULL,0,'Base role for all users','ROLE_USER', 'SYSTEM', NULL,'EN'),
  (-4,'2001-01-01 00:00',NULL,0,'Base role for all tutors','ROLE_TUTOR', 'COMPANY', NULL,'EN');
...
INSERT INTO ORG_MEMBERS (ID, DATE_CREATE, IS_ACTIVE, REF_COMPANY_ID, REF_USER_ID, ZOOM_USERNAME) VALUES
  (1, '2001-01-01 00:00', true, -1, 1, 'zoom_user1'),
  (2, '2001-01-01 00:00', true, -1, 2, 'zoom_user2'),
  (3, '2001-01-01 00:00', true, -1, 3, 'zoom_user3'),
  (4, '2001-01-01 00:00', true, -1, 4, 'zoom_user4'),
  (5, '2001-01-01 00:00', true, -1, 5, 'zoom_user5');